...
help:
	...
	@echo "  make run-suporte-dev      Roda o app 'Suporte Tec' em Dev."
	@echo "  make run-ae3-dev          Roda o app 'AE3 Tec' em Dev."
	@echo "  make icons tenant=<nome>  Gera todos os ícones para um tenant específico."
	@echo "                            Exemplo: make icons tenant=ae3tecnologia"
	@echo "--------------------------------------------------"