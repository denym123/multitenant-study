...
mixin _$User {
 ...
 int? get id; String? get username; Person? get person; List<String>? get roles; List<String>? get permissions; bool? get hasFiliation;
...
@override
String toString() {
  return 'User(id: $id, username: $username, person: $person, roles: $roles, permissions: $permissions, hasFiliation: $hasFiliation)';
}
...
@useResult
$Res call({
 int? id, String? username, Person? person, List<String>? roles, List<String>? permissions, bool? hasFiliation
});
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( int? id,  String? username,  Person? person,  List<String>? roles,  List<String>? permissions,  bool? hasFiliation)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _User() when $default != null:
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( int? id,  String? username,  Person? person,  List<String>? roles,  List<String>? permissions,  bool? hasFiliation)  $default,) {final _that = this;
switch (_that) {
case _User():
return $default(_that.id,_that.username,_that.person,_that.roles,_that.permissions,_that.hasFiliation);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( int? id,  String? username,  Person? person,  List<String>? roles,  List<String>? permissions,  bool? hasFiliation)?  $default,) {final _that = this;
switch (_that) {
case _User() when $default != null:
return $default(_that.id,_that.username,_that.person,_that.roles,_that.permissions,_that.hasFiliation);case _:
  return null;
...
class _User implements User {
   _User({this.id, this.username, this.person, final  List<String>? roles, final  List<String>? permissions, this.hasFiliation}): _roles = roles,_permissions = permissions;
